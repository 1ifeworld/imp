...
//         bytes32 nodeSchema = nodeRegistry.registerNodeSchema(mockUserId, new bytes(0));
//         nodeRegistry.registerNode(mockUserId, nodeSchema, new bytes(0));
//         nodeRegistry.messageNode(mockUserId, mockNodeId, bytes(0));
//     }    
