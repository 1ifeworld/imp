...
contract IdRegistryTest is Test {       
    ...
    function test_register() public {
        ...
        require(idRegistry.balanceOf(address(account)) == 1, "id 1 not registered correctly - balanceOf");
        require(idRegistry.ownerOf(1) == address(account), "id 1 not registered correctly - owner of");
